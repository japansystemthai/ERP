            ...
            <div id="main" class="mainpage">
                ...
                <form  method="post" action="Insert_Quotation.jsp" class="normal_form" onsubmit="return alertconfirm();">
                    <table class="myTable" align="center">
                        ...
                        <tr><th>Quote Date</th>
                            <td>
                                <input class=" form-control" type="date" name="date"  id="quote_date" required onchange="setUntill_Date()"/>
                            </td>
                            <td></td>
                            <th>Status</th>
                            <td>
                        ...
                        <tr><th>Valid until</th>
                            <td><input class=" form-control" type="date" name="valid_until" id="date_until" required/></td>
                            <td></td>
                            <th>Validity Term</th>
                            <td><input  class=" form-control" maxlength="50" type="text" name="valid_term"  value="This Price Quotation is valid 30 days"/></td>
                        </tr>
                        ...
                        <tr><th>Subject</th>
                            ...
                            <td></td>
                            <th>Delivery Term</th>
                            <td><input class=" form-control" maxlength="50" type="text" name="delivery_term"/></td>
                        </tr>
                        ...
                        <tr><th>Comment</th>
                            ...
                            <td></td>
                            <th>Payment Term</th>
                            <td><input  class=" form-control" type="text" name="payment_term"/></td>
                        </tr>
...
<!--                            <input style="width: 3%;margin-left: 0.5%" class="btn btn-danger" type="button" id="delrow"  value="-">
                            <input style="width: 10%;margin-left: 0.5%" class="btn btn-danger" id="delete_row" type="button" value="Delete Row"  />-->
                    ...
                    <table style=" margin-right: 3%"  align="right" >
                        <tr>
                            ...
                            <td style=" width: 30px"><input id="qt_amt_wotax" name="qt_amt_wotax" value="0.00" readonly="" style="text-align: right;"></td>
                            <td><span id="cur_sym1"></span></td>
                        </tr>
                        <tr>
                            <th style=" text-align: right">Discount : </th>
                            <td style=" width: 30px"><input id="qt_discount" name="qt_discount" value="0.00" readonly="" style="text-align: right;"></td>
                            <td><span id="cur_sym2"></span></td>
                        </tr>
                        <tr>
                            <th style=" text-align: right">Sub Total : </th>
                            <td style=" width: 30px"><input id="qt_subtotal" name="qt_subtotal" value="0.00" readonly="" style="text-align: right;" ></td>
                            <td><span id="cur_sym3"></span></td>
                        </tr>
                        <tr>
                            <th style=" text-align: right">Tax : </th>
                            <td style=" width: 30px"><input id="qt_tax" name="qt_tax" value="" readonly="" style="text-align: right;"></td>
                            <td>%</td>
                        </tr>
                        <tr>
                            <th style=" text-align: right">Vat : </th>
                            <td style=" width: 30px"><input id="qt_vat" name="qt_vat" value="0.00" readonly="" style="text-align: right;"></td>
                            <td><span id="cur_sym4"></span></td>
                        </tr>
                        <tr>
                            <th style=" text-align: right">Total Amount : </th>
                            <td style=" width: 30px"><input id="qt_amt" name="qt_amt" value="0.00" readonly="" style="text-align: right;"></td>
